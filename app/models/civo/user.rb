module Civo
  class User < Base
    ...
    get :everything, "/v#{ENV["CIVO_API_VERSION"] || "2"}/users/:id/everything", has_many: {accounts: Civo::Account, teams: Civo::Team, organisations: Civo::Organisation, roles: Civo::Role, team_members: Civo::TeamMember}
    if ENV["CIVO_API_VERSION"] == "2"
      get :all, "/v2/users"
      get :find_by_token, "/v2/users/token/:token"
      get :find_by, "/v2/users/find_by"
    end
